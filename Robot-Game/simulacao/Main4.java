...
public class Main4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            System.out.print("* Resultado : ");
             if (r1.getVida() && !r1.verificaAlimento(alimentoX, alimentoY)){
                ...
                System.out.println("Robô não pode se mover pois foi explodido.");
            }
        ...
        if (r1.verificaAlimento(alimentoX, alimentoY)){
            System.out.println("O robô " + r1.cor + " encontrou o alimento.");
        } else if (r2.verificaAlimento(alimentoX, alimentoY)){
            System.out.println("O robô " + r2.cor + " encontrou o alimento.");
        } else {
